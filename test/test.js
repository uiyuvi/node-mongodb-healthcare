...
*/
  describe('API testing started', () => {
    ...
    it('it should test deleteAppointment API', function (done) {
    ...
    it('it should test fetchSinglePatient API', function (done) {
    ...
    it('it should test getProfile API', function (done) {
    ...
    it('it should test fetchUsers API', function (done) {
